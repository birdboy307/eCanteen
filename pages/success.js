    ...
    return (
        <div className='flex justify-center bg-gray-50 h-screen items-center text-center'>
            <div className="grid grid-rows-3 gap-2">
                ...
                <button onClick={() => router.push('/')} className="border-4 font-medium rounded-lg mt-8 py-2.5 bg-white ease-in-out duration-300 hover:bg-gray-300">Return to home</button>
            </div>
        </div>
    )
}
